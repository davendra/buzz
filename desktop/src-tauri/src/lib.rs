...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            jarvis_voice::jarvis_speak,
            jarvis_voice::jarvis_stop_speaking,
            jarvis_voice::jarvis_tts_status,
            jarvis_voice::jarvis_google_tts,
            jarvis_voice::jarvis_google_voices,
